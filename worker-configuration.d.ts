/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 46ea1fb91cbbae8b72cc1df3c8e9eafd)
// Runtime types generated with workerd@1.20251217.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
		durableNamespaces: "Contacts";
	}
	interface Env {
		CONTACTS_KV: KVNamespace;
		VALUE_FROM_CLOUDFLARE: "House Of Knowledge";
		MIGRATE_TOKEN: "migrate-temp-4f3b7c";
		CONTACTS_DO: DurableObjectNamespace<import("./workers/app").Contacts>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "MIGRATE_TOKEN">> {}
}
